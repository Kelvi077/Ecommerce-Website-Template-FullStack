// Cart functionality for Aurora Home Furniture using server-side storage
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    updateCartItemPrices(); // Add this function to display individual prices
});
...
function setupEventListeners() {
    ...
    // Close modal buttons
    const closeModalButtons = document.querySelectorAll('.close-modal, .close-checkout-modal, .close-success-modal');
...
function incrementQuantity(itemId) {
    ...
    const quantityInput = document.querySelector(`.quantity-value[data-id="${itemId}"]`);
...
function handleCheckout(e) {
    ...
    if (!isValid) {
        document.getElementById('payment-errors').textContent = 'Please fill in all required fields';
        return;
    }
